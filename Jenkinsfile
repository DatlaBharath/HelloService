            ...
            steps {
                script {
                    ...
                    sh """
                        ...
                        ssh -i /var/test.pem -o StrictHostKeyChecking=no ubuntu@13.126.171.166 "kubectl apply -f -" < deployment.yaml
                        ssh -i /var/test.pem -o StrictHostKeyChecking=no ubuntu@13.126.171.166 "kubectl apply -f -" < service.yaml
                    """
                }
            }
        }
